<nav class="navbar navbar-expand-lg navbar-light primary-background">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
     ...
     <li class="nav-item">
        <a class="nav-link" href="https://www.google.com/maps/@18.8181772,76.7698374,7z"><span class="fa fa-envelope-open"></span> Contact</a>
      </li>
     <li class="nav-item">
        <a class="nav-link" href="login_page.jsp"><span class="fa fa-paper-plane-o"></span> Login</a>
      </li>
     <li class="nav-item">
